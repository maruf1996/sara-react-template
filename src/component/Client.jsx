  ...
  return (
    <section className="clients">
      <div className="container">
        ...
        <div className="row clients_slick mg_top_40px">
          <Slider {...settings}>
        ...
        <div className="row">
          <div className="col-xxl-12">
            <div className="clients_btn_main">
              <Link to="/testimonial" className="clients_btn">
                See all Feedback
              </Link>
            </div>
          </div>
